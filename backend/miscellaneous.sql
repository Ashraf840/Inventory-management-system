...
-- TABLE: customer
SELECT * FROM `inventory_mng_system`.`customer`;

INSERT INTO `inventory_mng_system`.`customer` (name, contact, email, address) VALUES ("cust-1", "98273498", "cust1@gmail.com", "cust-1 address");

INSERT INTO `inventory_mng_system`.`customer` (name, contact, email) VALUES ("cust-2", "365234765", "cust2@gmail.com");
INSERT INTO `inventory_mng_system`.`customer` (name, contact, email) VALUES ("cust-3", "435873459", "cust3@gmail.com");
INSERT INTO `inventory_mng_system`.`customer` (name, contact) VALUES ("cust-4", "435873459");

UPDATE `inventory_mng_system`.`customer` SET name="cust-4-updated", contact="2348729387", email="cust4@gmail.com", address="cust-4 address" WHERE id=4;
